          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xs bg-neutral-200 px-2 py-1 rounded text-neutral-700">
                  Driver
                </span>
              </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center">
                    <div className="h-8 w-8 rounded-full bg-secondary-500 flex items-center justify-center text-white mr-2">
                      {user?.fullName?.charAt(0) || "D"}
                    </div>
                    <span className="text-neutral-700">{user?.fullName || "Driver"}</span>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem>
                    <Link href="/driver/profile?tab=vehicle">
                      <div className="flex items-center w-full">
                  ...
                  <DropdownMenuItem>
                    <Link href="/driver/profile?tab=documents">
                      <div className="flex items-center w-full">
